...
/* FUNÇÕES PARA O CRUD DE ATOR */

//função para inserir um novo ator
const inserirNovoAtor = async function(contentType, ator){
    ...
    try {
        ...
        if(String(contentType).toUpperCase() == "APPLICATION/JSON"){
            ...
            let validando = await validarDadosAtor(ator)
            ...
            if(!validando){
                ...
                if(result){
                    ...
                    ator.id = result //criando o atributo ID no Json do ator e colocando o ID gerado no momento do insert
                    ...
                    message.DEFAULT_MESSAGE.response = ator //aparece os dados do ator do response para o usuário conferir
...
const atualizarAtor = async function(id, contentType, ator){
            ...
            if(String(contentType).toUpperCase() == "APPLICATION/JSON"){
                ...
                if(!validarDados){
                    ...
                    if(result){
                        ...
                        message.DEFAULT_MESSAGE.response = ator //envia os dados do ator no response, para o usuário visualizar
...
const validarDadosAtor = async function(dados){
